...
The project demonstrates practical data analysis skills, business insight generation, and professional documentation suitable for real-world analytics roles.
...
📌 \*Note:\* The dataset is included in the repository and can be downloaded directly for analysis.
...
git clone https://github.com/Vakavamsi/BMW-sales-data-EDA-1.git



\# Navigate to project directory

cd BMW-sales-data-EDA-1
...
├── BMW-Sales-2010-2024-EDA-1.ipynb
